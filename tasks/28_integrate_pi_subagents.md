...
Use the fake subagent support to test missing extension, old version, missing agent, unavailable model, unauthenticated model, successful foreground result, timeout, cancellation, mismatched correlation, listener cleanup, and repeated launches.
