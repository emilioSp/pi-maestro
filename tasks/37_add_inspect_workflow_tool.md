...
2. Discover the active workflow and highest authoritative revision.
3. Return phase, spec ID, base branch, branch and worktree facts, active-process facts, current handoff summary, blockers, and allowed recovery actions.
